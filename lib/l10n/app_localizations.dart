...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Start projecting your future today.'**
  ...
  /// No description provided for @authErrorShortName.
  ///
  /// In en, this message translates to:
  /// **'Name must be at least 2 characters'**
  String get authErrorShortName;
  ...
  /// No description provided for @profileStrategies.
  ///
  /// In en, this message translates to:
  /// **'Strategies'**
  String get profileStrategies;
  ...
  /// No description provided for @profileScenarios.
  ///
  /// In en, this message translates to:
  /// **'Scenarios'**
  String get profileScenarios;
  ...
  /// No description provided for @profileNotLoggedInSub.
  ///
  /// In en, this message translates to:
